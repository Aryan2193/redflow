...
**0:35 to 1:05. The first answer, written live, and the room asks back.**
Claude's answer writes itself into the left corner at about forty seconds, recommendation first. Two cards appear in the ring: "Asks the team." Say: "Before anyone argues, the lead asks the team what only the team can know." Shreya taps Reply on phone two and answers. Show her name land in the ring.

**1:05 to 1:40. Round two, the attack.**
The banner sweeps: Round 2, The attack. Cards slide into the right corner stamped HIT, the attacked claim highlighted in red, and on the left Claude's sections flash "Under attack." Say: "Every hit quotes the exact claim and says what would fix it. Heavy means the recommendation itself is at stake." If a fact check runs, point at the STANDS or REFUTED stamp in the ring with its source.
...
The ruling card lands in the ring: FIXED or STILL OPEN per hit, with the referee's line. The ring widens and the decision card scales in: the headline, the bottom line, what the debate changed and who caused it. Say: "What survived the fight is the answer. Anything still open stays on the page as a risk. Nothing quietly disappears." Tap Read the full answer.
